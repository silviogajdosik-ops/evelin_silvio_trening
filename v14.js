...
function openFocus(name){
 ...
 m.innerHTML=`<div class="info-backdrop" data-close-focus></div><section class="info-sheet focus-sheet"><div class="info-sheet-head"><div><p class="eyebrow">SPRAVA</p><h2>${esc(name)}</h2></div><button class="info-close" data-close-focus>×</button></div>${personFocus(name,'silvio')}${personFocus(name,'evelin')}</section>`;m.classList.add('open');
