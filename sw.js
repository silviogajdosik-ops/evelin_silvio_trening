const CACHE='training-tracker-v1.1.1';
const ASSETS=['./','./index.html','./styles.css?v=1.1.1','./pwa.css?v=1.1.1','./app.js?v=1.1.1','./manifest.webmanifest?v=1.1.1','./icons/icon.svg'];
