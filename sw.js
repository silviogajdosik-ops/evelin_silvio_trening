const CACHE='training-tracker-v1.1.0';
const ASSETS=['./','./index.html','./styles.css?v=1.1.0','./pwa.css?v=1.1.0','./app.js?v=1.1.0','./manifest.webmanifest?v=1.1.0','./icons/icon.svg'];
