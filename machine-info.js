// v1.2.1 — pouzdane SVG skice sprava za Android/PWA
const MACHINE_GUIDE={
...
function machineThumb(id,label){
 return `<div class="machine-thumb"><svg class="machine-sketch" viewBox="0 0 320 220" role="img" aria-label="Skica: ${esc(label)}"><use href="assets/machines.svg#${id}" xlink:href="assets/machines.svg#${id}"></use></svg></div>`;
}
